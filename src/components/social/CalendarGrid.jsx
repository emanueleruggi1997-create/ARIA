...
export default function CalendarGrid({ posts }) {
  ...
  const paddedStart = startDay === 0 ? 6 : startDay - 1; // Monday start
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-5">
      ...
      <div className="grid grid-cols-7 gap-px">
        ...
        {Array(paddedStart).fill(null).map((_, i) => (
        ...
        {days.map(day => {
          ...
          return (
            <div key={day.toISOString()} className={cn(
              "aspect-square rounded-lg p-1 text-center relative",
