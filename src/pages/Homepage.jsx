    ...
    <>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: isDesktop ? 1200 : "none", margin: "0 auto", width: "100%", display: "flex", alignItems: "center", gap: 0 }}>
          ...
          <img src="https://media.base44.com/images/public/69bfc400a0538988ee3a6cfd/56749d76c_logoemaralagentaitrasparente.png" alt="Emaral" style={{ width: 48, height: 48, objectFit: "contain" }} />
      ...
      <footer style={{ background: T.deep, borderTop: `1px solid ${T.border}`, padding: "28px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <img src="https://media.base44.com/images/public/69bfc400a0538988ee3a6cfd/56749d76c_logoemaralagentaitrasparente.png" alt="Emaral" style={{ width: 38, height: 38, objectFit: "contain" }} />
